                    ...
                    <div class="blog-page">
                        ...
                        <article class="blog__post d-flex flex-wrap">
                            <div class="thumb">
                                <a href="{{ $post->slug }}">
                                    @if ($post->media->count()>0)
                                        <img src="{{ asset('frontend/posts',$post->media->first()->file_name) }}" alt="blog images">
                                        @else
                            ...
                            <div class="content">
                                ...
                                <ul class="post__meta">
                                    <li>Posts by : <a href="{{ $post->slug }}">{{ $post->user->name }}</a></li>
                                    <li class="post_separator">/</li>
                                    <li>{{ $post->created_at->format('M d Y') }}</li>
                                </ul>
                                <p>{{ Str::limit($post->description, 145, '...') }}</p>
                                <div class="blog__btn">
                                    <a class="shopbtn" href="{{ $post->slug }}">read more</a>
                                </div>
                            </div>
                        </article>
